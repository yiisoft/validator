...
return [
    ...
    'This value is invalid.' => 'Qiymat notoʻgʻri.',
    'Must be a valid IP address.' => 'Toʻgʻri IP manzil boʻlishi kerak.',
    'Must not be an IPv4 address.' => 'IPv6 boʻlmasligi kerak.',
    ...
    'An object data set data can only have an array or an object type.' => 'Maʻlumotlar toʻplami qiymatlari massiv yoki obyekt boʻlishi kerak.',
    ...
    'Values must be ones of {values}.' => 'Qiymat quyidagilardan biri boʻlishi kerak: {values}.',
    'This value is not a valid URL.' => 'Qiymat havola emas.',
];
