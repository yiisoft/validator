...
final class Number extends AbstractNumber
{
    ...
    public function __construct(
        ...
        string $notNumberMessage = '{label} must be a number.',
        string $lessThanMinMessage = '{label} must be no less than {min}.',
        string $greaterThanMaxMessage = '{label} must be no greater than {max}.',
