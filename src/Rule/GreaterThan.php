 ...
 * ({@see GreaterThan::$targetValue}) or within an attribute ({@see GreaterThan::$targetProperty}).
 *
...
final class GreaterThan extends AbstractCompare
{
     ...
     * @param string|null $targetProperty The attribute to be greater than. When both this property and
