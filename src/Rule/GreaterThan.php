...
/**
 * Defines validation options to check that the specified value is greater than another value or attribute.
 *
...
{
    /**
     * @param scalar|null $targetValue The constant value to be greater than. When both this property and
     * {@see $targetAttribute} are set, this property takes precedence.
     * @param string|null $targetAttribute The attribute to be greater than. When both this property and {@see $targetValue} are set,
