    ...
    public function getOptions(?ErrorMessageFormatterInterface $formatter = null): array
    {
        return array_merge(
            ...
            [
                ...
                'ipv4NotAllowedMessage' => (new ErrorMessage($this->ipv4NotAllowed))->getFormattedMessage($formatter),
                'allowIpv6' => $this->allowIpv6,
                'ipv6NotAllowedMessage' => (new ErrorMessage($this->ipv6NotAllowed))->getFormattedMessage($formatter),
                'allowSubnet' => $this->allowSubnet,
                'hasSubnetMessage' => (new ErrorMessage($this->hasSubnet))->getFormattedMessage($formatter),
                'requireSubnet' => $this->requireSubnet,
                'noSubnetMessage' => (new ErrorMessage($this->noSubnet))->getFormattedMessage($formatter),
                'allowNegation' => $this->allowNegation,
                'wrongCidrMessage' => (new ErrorMessage($this->wrongCidr))->getFormattedMessage($formatter),
                'ranges' => $this->ranges,
                'notInRangeMessage' => (new ErrorMessage($this->notInRange))->getFormattedMessage($formatter),
            ],
        );
    }
}
