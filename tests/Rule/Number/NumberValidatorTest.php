 ...
 * @group t2
 */
final class NumberValidatorTest extends AbstractRuleValidatorTest
{
    public function failedValidationProvider(): array
    {
        ...
        return [
            [$rule, '12:45', [new Error($rule->getNotANumberMessage(), ['value' => '12:45'])]],

            [$rule, false, [new Error($rule->getNotANumberMessage(), ['value' => false])]],
            [$rule, true, [new Error($rule->getNotANumberMessage(), ['value' => true])]],

            [$rule, 'e12', [new Error($rule->getNotANumberMessage(), ['value' => 'e12'])]],
            [$rule, '-e3', [new Error($rule->getNotANumberMessage(), ['value' => '-e3'])]],
            [$rule, '-4.534-e-12', [new Error($rule->getNotANumberMessage(), ['value' => '-4.534-e-12'])]],
            [$rule, '12.23^4', [new Error($rule->getNotANumberMessage(), ['value' => '12.23^4'])]],
            [$rule, '43^32', [new Error($rule->getNotANumberMessage(), ['value' => '43^32'])]],

            [$rule, [1, 2, 3], [new Error($rule->getNotANumberMessage(), ['value' => [1, 2, 3]])]],
            [$rule, $object = new stdClass(), [new Error($rule->getNotANumberMessage(), ['value' => $object])]],
            [$rule, $resource = fopen('php://stdin', 'rb'), [new Error($rule->getNotANumberMessage(), ['value' => $resource])]],

            [$ruleInteger, 25.45, [new Error($ruleInteger->getNotANumberMessage(), ['value' => 25.45])]],
            [$ruleInteger, '25,45', [new Error($ruleInteger->getNotANumberMessage(), ['value' => '25,45'])]],
            [$ruleInteger, '0x14', [new Error($ruleInteger->getNotANumberMessage(), ['value' => '0x14'])]],

            [$ruleInteger, '-1.23', [new Error($ruleInteger->getNotANumberMessage(), ['value' => '-1.23'])]],
            [$ruleInteger, '-4.423e-12', [new Error($ruleInteger->getNotANumberMessage(), ['value' => '-4.423e-12'])]],
            [$ruleInteger, '12E3', [new Error($ruleInteger->getNotANumberMessage(), ['value' => '12E3'])]],
            [$ruleInteger, 'e12', [new Error($ruleInteger->getNotANumberMessage(), ['value' => 'e12'])]],
            [$ruleInteger, '-e3', [new Error($ruleInteger->getNotANumberMessage(), ['value' => '-e3'])]],
            [$ruleInteger, '-4.534-e-12', [new Error($ruleInteger->getNotANumberMessage(), ['value' => '-4.534-e-12'])]],
            ...
            [new Number(asInteger: true, max: 1.25), '22e-12', [new Error($ruleInteger->getNotANumberMessage(), ['value' => '22e-12'])]],
    ...
    public function customErrorMessagesProvider(): array
    {
        return [
            [
                ...
                0,
                [new Error('Value is too small.', ['min' => 5])],
            ],
        ];
    }
