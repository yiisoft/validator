...
use Yiisoft\Validator\Rule\GreaterThanHandler;
...
final class GreaterThanHandlerTest extends AbstractRuleValidatorTest
{
    public function failedValidationProvider(): array
    {
        ...
        return [
            ...
            [
                new GreaterThan(targetAttribute: 'attribute'),
                '100',
                [new Error($this->formatMessage($messageGreaterThan, ['targetValueOrAttribute' => 'attribute']))],
            ],
        ];
    }
