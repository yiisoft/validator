...
class ValidatorTest extends TestCase
{
    ...
    public function testCreateValidator()
    {
        ...
        $this->assertInstanceOf(Number::class, $numberVal);
        ...
        $this->assertInstanceOf(Boolean::class, $val);
        ...
        $this->assertInstanceOf(Inline::class, $val);
    ...
    public function testCreateBuiltInValidatorWithSameNameFunction()
    {
        ...
        $this->assertInstanceOf(Required::class, $validator);
    }
    ...
    public function testValidateAttribute()
    {
        ...
        $val = Rule2::createValidator('inlineVal', $model, ['val_attr_a'], ['params' => ['foo' => 'bar']]);
        ...
        $this->assertInstanceOf(Inline::class, $args[2]);
    }
