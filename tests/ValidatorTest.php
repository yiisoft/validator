...
class ValidatorTest extends TestCase
{
    ...
    public function initSkipOnEmptyDataProvider(): array
    {
        $translator = (new TranslatorFactory())->create();
        return [
            [new Validator(new SimpleRuleHandlerContainer($translator)), null, null],
            [new Validator(new SimpleRuleHandlerContainer($translator), skipOnEmpty: false), false, SkipNone::class],
            [new Validator(new SimpleRuleHandlerContainer($translator), skipOnEmpty: true), true, SkipOnEmpty::class],
            [
                new Validator(new SimpleRuleHandlerContainer($translator), skipOnEmptyCallback: new SkipOnNull()),
                true,
                SkipOnNull::class,
